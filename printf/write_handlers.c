...
/**
 * handle_write_char - Handles writing a single char to the
 * buffer with padding.
 ...
 *
 * Return: The no. of chars written to the std/o.
 */
...
/**
 * write_number - Handles writing a formatted no. to the std/o.
 * @is_negative: A flag indicating if the number is negative (1) or not (0).
...
/**
 * write_num - Handles writing a formatted no. to the std/o.
 * @ind: The index where the number starts in the buffer.
 * @buffer: The buffer containing the formatted number.
 * @flags: The flags used for formatting.
 * @width: The width used for formatting.
...
/**
 * write_unsgnd - Handles writing a formatted unsigned no. to the std/o.
...
/**
 * write_pointer - Handles writing a formatted pointer address to the std/o.
 ...
 *
 * Return: The no. of chars written to the standard output.
 */
